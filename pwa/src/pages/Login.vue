<template>
  ...
  <div class="fixed bottom-0 flex justify-end w-full sm:w-96">
    <transition name="fade">
      <div
        v-if="loginSuccess"
        class="w-full sm:w-72 p-2 mb-4 text-sm leading-5 text-white bg-green-500 rounded-lg opacity-100 font-regular animate-slide-in-right animate-fade-out"
      >
        Login successfully
      </div>
    </transition>
    <transition name="fade">
      <div
        v-if="loginError"
        class="w-full sm:w-72 p-2 mb-4 text-sm leading-5 text-white bg-red-500 rounded-lg opacity-100 font-regular animate-slide-in-right animate-fade-out"
      >
        Login failed
      </div>
    </transition>
