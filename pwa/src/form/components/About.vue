			...
			<div class=" p-4">
				<div class=" w-full p-3 bg-white rounded-lg">
					...
					<div class=" w-full flex justify-center ">
						<p class="text-xl font-semibold text-black mt-2">{{ userDetails.data[0].full_name }}</p>
					</div>
					<div class="p-2">
						<div class=" w-full  h-[12rem] rounded-md mt-1">
							<hr></hr>
							<div class=" flex ml-2 mt-1">
								<p class=" text-[14px] text-gray-600  w-[5rem] truncate">Username</p>
								<!-- <p class=" text-[14px] ">:</p> -->
								<p class=" text-[14px]  ml-auto">{{userDetails.data[0].username}}</p>
							</div>
							<div class=" flex ml-2 mt-1">
								<p class=" text-[14px] text-gray-600   w-[5rem] truncate">Email</p>
								<!-- <p class=" text-[14px] ">:</p> -->
								<p class=" text-[14px]   ml-auto">{{userDetails.data[0].email}}</p>
							</div>
							<div class=" flex ml-2 mt-1">
								<p class=" text-[14px] text-gray-600   w-[5rem] truncate">Mobile No</p>
								<!-- <p class=" text-[14px] ">:</p> -->
								<p class=" text-[14px]   ml-auto">{{userDetails.data[0].mobile_no}}</p>
							</div>
							<div class=" flex ml-2 mt-1">
								<p class=" text-[14px] text-gray-600   w-[5rem] truncate">Gender</p>
								<!-- <p class=" text-[14px] ">:</p> -->
								<p class=" text-[14px]   ml-auto">{{userDetails.data[0].gender}}</p>
							</div>
							<div class=" flex ml-2 mt-1">
								<p class=" text-[14px] text-gray-600   w-[5rem] truncate">Date of Birth</p>
								<!-- <p class=" text-[14px] ">:</p> -->
								<p class=" text-[14px]   ml-auto">{{userDetails.data[0].birth_date}}</p>
							</div>
							<div class=" flex ml-2 mt-1">
								<p class=" text-[14px] text-gray-600   w-[5rem] truncate">Role Profile</p>
								<!-- <p class=" text-[14px] ">:</p> -->
								<p class=" text-[14px]   ml-auto">{{userDetails.data[0].role_profile_name}}</p>
							</div>
							<div class=" flex ml-2 mt-1">
								<p class=" text-[14px] text-gray-600   w-[5rem] truncate">Language</p>
								<!-- <p class=" text-[14px] ">:</p> -->
								<p class=" text-[14px]   ml-auto">{{lang}}</p>
							</div>
						</div>
					</div>
					<div class=" w-full flex justify-center  p-2">
						<div @click="close" class=" h-[2rem] bg-red-200 w-full rounded-md border-red-400 border-[0.5px] hover:cursor-pointer touchable">
